...
Today, EcoMush is dedicated to bringing clean, fresh, protein-rich mushrooms to every home.
            ...
            <div className="author-info">
              ...
              {/* Founder Social Media Icons */}
              <div className="founder-social-icons">
                <a 
                  href="https://www.instagram.com/aswinnchandran" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.facebook.com/aswin.chandran.9822" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="founder-social-icon"
                  aria-label="Facebook"
                ...
                <a 
                  href="https://www.linkedin.com/in/aswin-chandran-8b852a1a9/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="founder-social-icon"
                  aria-label="LinkedIn"
